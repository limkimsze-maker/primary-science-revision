...
let sub=document.querySelector("header .sub");if(sub)sub.innerHTML='<b>180 book-backed Science concepts</b> · <b>4–6 application questions per concept</b> · <b>past-paper/remediation profile applied</b> · no-repeat question cycling';
